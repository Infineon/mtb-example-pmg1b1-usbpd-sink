...
APPNAME=mtb-example-pmg1b1-usbpd-sink
...
DEFINES=CY_PD_SINK_ONLY=1 CY_PD_SOURCE_ONLY=0 CY_PD_REV3_ENABLE=1 CY_PD_CBL_DISC_DISABLE=1 \
        VBUS_OVP_ENABLE=1 VBUS_UVP_ENABLE=1 VBUS_OCP_ENABLE=0 SYS_DEEPSLEEP_ENABLE=0 \
        CY_PD_USB4_SUPPORT_ENABLE=0 CY_PDUTILS_TIMER_TYPE=3

        DEFINES+=VBUS_RCP_ENABLE=0 VBUS_SCP_ENABLE=0 VCONN_OCP_ENABLE=0 VCONN_SCP_ENABLE=0

PDSTACK_DEFINES=CY_PD_VCONN_DISABLE=1 CY_USE_CONFIG_TABLE=0\
        CY_PD_BIST_MODE_DISABLE=0 CY_PD_REV3_ENABLE=1 CY_PD_EPR_ENABLE=0 CY_PD_EPR_AVS_ENABLE=0
